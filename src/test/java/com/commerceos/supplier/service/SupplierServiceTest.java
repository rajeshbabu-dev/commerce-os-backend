...
import com.commerceos.supplier.service.impl.SupplierServiceImpl;
...
class SupplierServiceTest {
  ...
  void createSupplier_DuplicateEmail() {
    CreateSupplierRequestDto req =
        new CreateSupplierRequestDto("Acme", "acme@test.com", "123", "Addr", "NET_30");
  ...
  void createSupplier_Success() {
    ...
    SupplierResponseDto response = supplierService.createSupplier(req);
  ...
  void mapProduct_ResetsPreviousPrimary() {
    ...
    SupplierProduct oldPrimary =
        SupplierProduct.builder()
            ...
            .isPrimary(true)
            .build();
    SupplierProductResponseDto dummyResp =
        new SupplierProductResponseDto(
            UUID.randomUUID(),
            supplierId,
            "Acme",
            productId,
    ...
    MapSupplierProductRequestDto req =
        new MapSupplierProductRequestDto(productId, new BigDecimal("50.00"), 5, true);
    SupplierProductResponseDto res = supplierService.mapProduct(supplierId, req);
