 ...
 *
 * <p>No endpoint should ever return a raw stack trace. Every response is a structured JSON payload
 * with {@code type}, {@code title}, {@code status}, {@code detail}, and {@code instance} fields,
 * consistent with the frontend's error boundary contract in the frontend spec §2.1.
 */
...
public class GlobalExceptionHandler {
  ...
  private static final String DEFAULT_INSTANCE = "/api/v1/error";
  ...
  public ProblemDetail handleBadCredentials(BadCredentialsException ex) {
    // Never reveal whether the email or password was wrong — per security doc §4
    ProblemDetail detail =
